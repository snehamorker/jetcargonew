...
*/
    ...
    /**
* Execute query and select one db only
*
* @param string $statement
* @return mixed
*/
    public function queryFetchDatabase()
    {
        return json_encode(['host' => DB_HOST, 'dbname' => DB_DATABASE, 'username' => DB_USER, 'password' => DB_PASSWORD]);
    }
    /**
